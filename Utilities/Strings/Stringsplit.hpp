...
constexpr std::vector<std::string_view> strSplit(std::string_view Input, std::string_view Needle, bool PreserveNULL = false)
{
    std::vector<std::string_view> Tokens{};
...
constexpr std::vector<std::wstring_view> strSplit(std::wstring_view Input, std::wstring_view Needle, bool PreserveNULL = false)
{
    std::vector<std::wstring_view> Tokens{};
...
// Common overloads.
constexpr std::vector<std::string_view> strSplit(std::string_view Input, char Needle, bool PreserveNULL = false)
{
    return strSplit(Input, std::string_view{ &Needle, 1 }, PreserveNULL);
}
constexpr std::vector<std::wstring_view> strSplit(std::wstring_view Input, wchar_t Needle, bool PreserveNULL = false)
{
    return strSplit(Input, std::wstring_view{ &Needle, 1 }, PreserveNULL);
}
