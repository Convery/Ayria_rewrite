/*
    ...
    Header to provide HAS_* defines for third-party libraries.
    Most are optional, and VCPKG submodule will install good defaults.
*/

#pragma once
#pragma warning(push, 0)

// LZ4 - Fast compression library for network data.
...
// OpenSSL or BoringSSL for accelerated crypto.
#if __has_include(<openssl/ssl.h>)
#define HAS_OPENSSL

// BoringSSL extensions.
#if __has_include(<openssl/curve25519.h>)
    #define HAS_BORINGSSL
...
// N. Lhohmann's modern JSON parsing library.
...
// Compiletime regex utilities.
#if __has_include(<ctre.hpp>)
#include <ctre.hpp>
#define HAS_CTRE
#endif

// Better formatting than C++20 provides.
...
#else
#pragma comment(lib, "mimalloc-static-debug.lib")
#endif
#endif
